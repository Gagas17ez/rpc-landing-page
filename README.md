...
```
cd existing_repo
git remote add origin https://gitlab.com/dianakd/rakitpc-landingpage.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/dianakd/rakitpc-landingpage/-/settings/integrations)
